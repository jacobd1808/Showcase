...
<header>
  <nav>
      ...
      <div class='user-profile-tab'> 
        <a href='#' class='main-link tab-heading model-popup' data-content='profile' data-title="<?= $user_profile['name'].' '.$user_profile['surname']; ?>'s profile" data-profile-id='<?= $user_profile['id'] ?>'><?= $user_profile['name'] ?> <?= $user_profile['surname'] ?><i class="material-icons">account_circle</i> </a>
        <ul class='user-menu'> 
