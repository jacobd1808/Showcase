...
<header>
  <nav>
      ...
      <div class='user-profile-tab'> 
        <a href='#' class='main-link tab-heading model-popup' data-content='profile' data-title='Someones Profile' data-profile-id='3'><?= $name ?> <?= $surname ?><i class="material-icons">account_circle</i> </a>
        <ul class='user-menu'> 
