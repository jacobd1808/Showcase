      ...
      <div class='m-25'>
        ...
        <div class='feed-notices'> 
          <div class='modulated-box'>
            ...
            <?php for($i = 0; $i < 3; $i++ ) { ?>
            <div class='mini-tile pure-g'> 
              <h3 class='pure-u-1-1'> Some Name </h3>
                  <div class='pure-u-8-24 l-float c-align rec-tile'>
                    <img src='http://i.imgur.com/HQ3YU7n.gif' alt='user avatar' class='user-avatar'/>
                  </div>
                  <div class='pure-u-8-24 l-float'> 
                      <strong>Goal</strong>
                      <div class='click-tile click-goal img-tile tooltip bottom-tooltip' 
                      style="background-image:url('assets/img/icons/goals/1.png')"
                      title=' '>
                      </div>
                  </div>
                  <div class='pure-u-8-24 l-float'> 
                      ...
                      <div class='click-tile click-goal img-tile tooltip bottom-tooltip' 
                      style="background-image:url('assets/img/icons/length/1.png')"
                      title=' '>
                      </div>
                  </div>
            </div>
